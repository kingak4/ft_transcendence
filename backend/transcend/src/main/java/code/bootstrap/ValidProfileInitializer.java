...
public class ValidProfileInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
  ...
  public void initialize(ConfigurableApplicationContext context) {
    ...
    String[] allowed = Binder.get(env)
        .bind("spring.allowed-profiles", String[].class)
        .orElse(new String[0]);
